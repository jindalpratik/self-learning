...
for i in range(t):
    ...
    s = n - k
    # The number of ways of making s selections from among r distinguishable possibilities, where the order does not matter and repetitions are allowed is (k+s-1)!/((k-1)!*(s)!) which is equal to (n-1)!/(k-1)! in this case as s is equal to n - k.
