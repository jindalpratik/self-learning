...
function showMeme() {
  ...
  const d_meme = document.querySelector(".meme");
  const img = document.createElement("img");
  img.setAttribute("src", randomMemeUrl);
  img.setAttribute("id", "shown");
  d_meme.appendChild(img);
}
...
function showJoke() {
  ...
  const d_joke = document.querySelector(".joke");
  const p = document.createElement("p");
  p.textContent = randomJokeText;
  p.setAttribute("id", "shown");
  d_joke.appendChild(p);
}
...
function showQuote() {
  ...
  const d_quote = document.querySelector(".quote");

  const div = document.createElement("div");
  div.setAttribute("id","shown");

  const p_quote = document.createElement("p");
  p_quote.textContent = randomQuote.quote;

  const p_author = document.createElement("p");
  p_author.textContent = "- " + randomQuote.author;

  div.appendChild(p_quote);
  div.appendChild(p_author);
  d_quote.appendChild(div);
}
...
function showRiddle() {
  ...
  const d_riddle = document.querySelector(".riddle");

  const div = document.createElement("div");
  div.setAttribute("id","shown");

  const p_question = document.createElement("p");
  p_question.textContent = randomRiddle.question;

  const p_answer = document.createElement("p");
  p_answer.textContent = "- " + randomRiddle.answer;
  p_answer.setAttribute("hidden","");
  p_answer.setAttribute("id","isRiddle")

  div.appendChild(p_question);
  div.appendChild(p_answer);
  d_riddle.appendChild(div);
}

function revealAnswers() {
  const isRiddle = document.getElementById("isRiddle");
  if(isRiddle && isRiddle.hidden)
    isRiddle.removeAttribute("hidden");
  else if(isRiddle && !isRiddle.hidden){
